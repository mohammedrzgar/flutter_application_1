...
/// Change the name to ViewWrapper since View has conflict name with other built in
class ViewWrapper<V extends Viewmodel> extends StatefulWidget {
  final Widget Function(BuildContext context, V model, Widget? child) builder;
  final Function(V)? onModelReady;
  ...
  @override
  _ViewWrapperState<V> createState() => _ViewWrapperState<V>();
}

class _ViewWrapperState<V extends Viewmodel> extends State<ViewWrapper<V>> {
  V model = locator<V>();
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<V>.value(
      value: model,
      child: Consumer<V>(builder: widget.builder),
    );
  }
}
